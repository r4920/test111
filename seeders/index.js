...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'Ma88q1ceyLiBj6O',
      'isDeleted':false,
      'username':'Sterling.Rau',
      'email':'Gregory_Hahn60@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Sterling.Rau' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'eLpiL3leFJSIIEJ',
      'isDeleted':false,
      'username':'Janet_Vandervort',
      'email':'Abner.Schmeler16@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Janet_Vandervort' }, userToBeInserted,  { upsert: true });

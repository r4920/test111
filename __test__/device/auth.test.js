...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Eulah.Armstrong',
      password: 'Eshv3249h13Y_cf',
      email: 'Stuart58@hotmail.com',
      name: 'Mrs. Ira Powlowski',
      userType: 800,
      mobileNo: '(589) 308-3734',
      resetPasswordLink: {},
      loginRetryLimit: 880,
      loginReactiveTime: '2022-11-27T15:59:23.898Z',
      id: '626a92574d2dc51b51db508f'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Madyson1',
        'password':'p_K2oWSdA12SAVX',
        'email':'Velda18@yahoo.com',
        'name':'Frankie Adams',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(039) 971-3577',

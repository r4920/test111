...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Brenda52',
      password: '2bCwSjxlfmeDdz4',
      email: 'Alvah_Berge@yahoo.com',
      name: 'Sue Herman',
      userType: 602,
      mobileNo: '(237) 610-6400',
      resetPasswordLink: {},
      loginRetryLimit: 720,
      loginReactiveTime: '2022-07-08T06:53:57.533Z',
      id: '626a92574d2dc51b51db5065'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Rico.Funk36',
        'password':'zq8doy6lUDvCl23',
        'email':'Hope38@gmail.com',
        'name':'Dr. Maurice Hand',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(267) 670-1056',
